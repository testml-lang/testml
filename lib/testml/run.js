  ...
  module.exports = TestML.Run = (function() {
    class Run {
      ...
      constructor(params = {}) {
        ...
        this.transform1 = this.transform1.bind(this);
        this.transform2 = this.transform2.bind(this);
      ...
      interpolate(string, label = false) {
        string = string.replace(/\{([\-\w]+)\}/g, (m, name) => {
          return this.transform1(name, label);
        });
        string = string.replace(/\{\*([\-\w]+)\}/g, (m, name) => {
          return this.transform2(name, label);
        });
        return string;
      }
      ...
      transform1(name, label) {
        ...
        return this.transform(value, label);
      }
