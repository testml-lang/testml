...
(function() {
  ...
  module.exports = TestML.Run = (function() {
    class Run {
      ...
      //----------------------------------------------------------------------------
      exec(expr, context = []) {
        var args, call, name, opcode, return_;
        ...
        if (call = this.constructor.vtable[opcode]) {
          ...
          if (args.length === 0 && (this.vars[name] != null)) {
            return_ = this.vars[name];
      ...
      exec_expr(...calls) {
        ...
        for (i = 0, len = calls.length; i < len; i++) {
          call = calls[i];
          if (!this.error) {
            if (this.get_type(call) === 'expr' && (this.vars[call[0]] != null)) {
              call = this.vars[call[0]];
            }
            try {
